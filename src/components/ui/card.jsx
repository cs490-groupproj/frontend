...
function Card({ className, size = "default", ...props }) {
  return (
    <div
      ...
      data-size={size}
      className={cn(
        `group/card bg-card text-card-foreground ring-foreground/10 flex
        flex-col gap-4 overflow-hidden rounded-xl py-4 text-sm ring-1
        has-data-[slot=card-footer]:pb-0 has-[>div:first-child]:pt-0
  ...
  return (
    <div
      ...
      className={cn(
        ...
        items-center gap-1 rounded-t-xl px-4 group-data-[size=sm]/card:px-3
