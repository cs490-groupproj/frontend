...
export default function ClientManagement() {
  ...
  if (requestsLoading || clientsLoading || !clientsData || !requestsData) {
    return (
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-foreground text-3xl font-bold">My Clients</h1>
                ...
                <div className="flex items-center justify-center gap-2">
                  <Button asChild variant="outline">
                    <Link
                      ...
                      className="hover:bg-muted shrink-0 rounded-lg border px-4
